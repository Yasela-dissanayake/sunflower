  ...
  const values = [
    {
      ...
      description:
        "Every session is approached with deep compassion, creating a safe space for your healing journey.",
    },
    {
      icon: Sparkles,
      title: "Holistic Approach",
      description:
        "I address the whole person - mind, body, and spirit - for complete transformation.",
    },
    {
      icon: Users,
      title: "Personalized Sessions",
      description:
        "Each healing session is tailored to your unique needs, goals, and energy.",
    },
    {
      icon: Award,
      title: "Professional Excellence",
      description:
        "Committed to ongoing learning and maintaining the highest standards of practice.",
    },
  ];
            ...
            >
              <CarouselContent>
                {certifications.map((cert, index) => (
                  ...
                  >
                    <Card
                      className="p-6 text-center border-border animate-fade-in-up hover:scale-105 transition-transform duration-300 mx-2"
