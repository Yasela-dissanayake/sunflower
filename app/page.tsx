...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-amber-50/30 relative">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-4xl font-serif font-bold text-gradient-sunflower">Sunflowers</span>
          </div>
          ...
          {/* Desktop CTA */}
          <button className="hidden md:block ml-6 gradient-sunflower text-white px-9 py-4 rounded-full text-base font-semibold hover:scale-105 hover:shadow-xl transition-all duration-300">
            Book Session
          </button>
        ...
        >
          <div className="px-6 pb-6 space-y-4">
            ...
            <button className="w-full gradient-sunflower text-white px-9 py-4 rounded-full text-base font-semibold">
              Book Session
            </button>
          </div>
        </div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full py-20">
          <div className="max-w-3xl">
            {/* Badge */}
            <div className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-sm px-7 py-3 rounded-full text-base font-semibold text-amber-700 shadow-lg mb-8 animate-fade-in border border-amber-200">
              <Sun className="w-5 h-5 animate-pulse-gentle" />
              <span>Rooted in Energy, Created with Love</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-5 leading-[1] animate-slide-in-left">
      ...
      {/* ABOUT SECTION */}
      <section className="py-24 px-6 bg-gradient-to-b from-white to-amber-50 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-amber-600 font-bold text-sm uppercase tracking-wider mb-3">About Me</p>
            <h2 className="text-2xl md:text-3xl font-serif font-bold mb-3">Your Guide to Healing</h2>
            <div className="w-20 h-0.5 bg-gradient-to-r from-amber-400 to-orange-500 mx-auto rounded-full" />
          </div>
          ...
          <div className="max-w-5xl mx-auto space-y-8 text-lg text-gray-700 leading-relaxed mb-20">
            <div className="bg-gradient-to-r from-amber-100 to-orange-100 px-8 py-6 rounded-2xl shadow-lg border border-amber-200">
              <p className="text-2xl md:text-3xl font-serif italic text-center text-amber-700 mb-0">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            <div className="bg-white p-10 rounded-2xl shadow-xl border-2 border-amber-100 hover:shadow-2xl transition-shadow">
              <div className="w-12 h-12 gradient-sunflower rounded-2xl flex items-center justify-center mb-6">
                <Heart className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-3xl font-serif font-bold mb-6 text-gray-900">Mission</h3>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-xl border-2 border-amber-100 hover:shadow-2xl transition-shadow">
              <div className="w-12 h-12 gradient-sunset rounded-2xl flex items-center justify-center mb-6">
                <Sun className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-3xl font-serif font-bold mb-6 text-gray-900">Vision</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
          ...
          <div className="max-w-5xl mx-auto mb-20">
            <div className="text-center mb-12">
              ...
              <h3 className="text-3xl md:text-4xl font-serif font-bold">Certifications & Training</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-5">
              {certifications.map((cert, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 bg-gradient-to-r from-amber-50 to-orange-50 px-5 py-4 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-amber-100"
                >
                  <div className="flex-shrink-0">
                    <div className="w-10 h-10 gradient-sunflower rounded-lg flex items-center justify-center">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h3 className="text-3xl md:text-4xl font-serif font-bold">My Approach</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              {approaches.map((approach, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex gap-4 bg-white px-6 py-5 rounded-xl shadow-md hover:shadow-lg transition-all border border-amber-100"
                  >
                    <div className="flex-shrink-0">
                      <div className="w-11 h-11 gradient-sunflower rounded-lg flex items-center justify-center">
      ...
      <section className="py-32 px-6 bg-gradient-to-b from-amber-50 to-white relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Holistic Healing Modalities</h2>
            ...
            {services.map((service, index) => {
              ...
              return (
                <div key={service.title} className={`group ${isLast ? "lg:col-start-2" : ""}`}>
                  <div
                    className={`relative bg-gradient-to-br ${service.color} px-6 py-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-white hover:border-amber-200 cursor-pointer hover:-translate-y-1 h-full overflow-hidden`}
                  >
                    {/* Icon */}
                    <div
                      className={`${service.iconBg} w-12 h-12 rounded-xl flex items-center justify-center mb-4 group-hover: scale-105 group-hover:rotate-6 transition-all duration-500 shadow-md`}
                    >
                    ...
                    <div className="max-h-0 overflow-hidden group-hover:max-h-20 transition-all duration-500 ease-in-out">
                      <p className="text-sm text-amber-700 font-medium bg-amber-100/50 p-3 rounded-lg mt-2">
                        {service.details}
                      </p>
                    </div>

                    {/* Learn More Link */}
                    <div className="flex items-center gap-2 text-amber-600 font-semibold group-hover:gap-3 transition-all mt-3">
                    ...
                    <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                      <div className={`absolute inset-0 ${service.iconBg} opacity-10 rounded-2xl`} />
                    </div>
                  </div>
                </div>
              )
      ...
      <section className="py-32 px-6 bg-gradient-to-b from-white to-amber-50 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6">Stories of Transformation</h2>
          ...
          >
            ...
            <div className="bg-white p-12 rounded-3xl shadow-2xl border-2 border-amber-100 relative overflow-hidden">
              {/* Quote decoration */}
              <div className="absolute top-6 left-6 text-6xl text-amber-200 font-serif leading-none">"</div>
      ...
      <section id="contact" className="py-32 px-6 bg-gradient-to-b from-white to-amber-50 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md: text-4xl font-serif font-bold mb-4">Start Your Healing Journey</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-10 rounded-3xl shadow-2xl border-2 border-amber-100">
              <h3 className="text-2xl font-serif font-bold mb-8 text-gray-900">Send a Message</h3>
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-amber-200 focus:border-amber-500 focus:outline-none transition-all duration-300 bg-amber-50/30"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1.5">What brings you here?</label>
                  <textarea
                ...
                <button
                  type="submit"
                  className="w-full gradient-sunflower text-white px-6 py-4 rounded-full text-base font-bold hover:scale-105 hover: shadow-xl transition-all duration-300 flex items-center justify-center gap-2 group relative overflow-hidden"
                >
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-amber-100 to-orange-100 px-8 py-8 rounded-2xl shadow-lg border border-amber-200">
                <h3 className="text-2xl font-serif font-bold mb-8 text-gray-900">Let's Connect</h3>

                <div className="space-y-5">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 gradient-sunflower rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      {/* FINAL CTA */}
      <section className="py-16 px-6 gradient-sunflower relative overflow-hidden z-10">
        {/* Decorative Elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-8 right-8 w-52 h-52 bg-white/10 rounded-full blur-3xl" />
          <div className="absolute bottom-8 left-8 w-64 h-64 bg-white/10 rounded-full blur-3xl" />
        </div>

        <div className="relative max-w-4xl mx-auto text-center">
          <div className="mb-4">
            <Flower2 className="w-10 h-10 text-white mx-auto animate-float drop-shadow-lg" />
          </div>

          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-3 text-white drop-shadow-lg">
            Ready to Begin Your Journey? 
          </h2>

          <p className="text-xl md:text-2xl text-white/95 italic mb-4 drop-shadow-md">
            Like sunflowers turning toward the light, we too can rise, heal, and bloom. 
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button className="bg-transparent border border-white text-white px-8 py-3 rounded-full text-lg font-bold hover:bg-white/10 hover:scale-105 transition-all duration-300">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center mb-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-serif font-bold">Sunflowers</span>
            </div>
            <p className="text-gray-400 text-lg mb-5 italic">Rooted in energy, Created with love</p>
            <div className="flex flex-wrap justify-center gap-5 text-gray-400 mb-6">
          ...
          <div className="pt-1 border-t border-gray-800 text-center">
