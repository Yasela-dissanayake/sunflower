...
import { Sparkles, Clock, Users, CheckCircle, AlertCircle } from "lucide-react"
    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <h1 className="text-5xl font-bold text-foreground mb-6">It's all about Chakras</h1>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Discover your inner harmony through chakra balancing. Experience emotional freedom, renewed lightness,
                and deeper joy as you align your energy centers.
              </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 animate-fade-in">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold text-foreground mb-6">Embracing Balance</h2>
          <div className="prose prose-lg max-w-none">
            <h3 className="text-2xl font-semibold text-foreground mb-4">What are Chakras?</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              The term "Chakra" originates from Sanskrit, meaning "wheel" or "disk." Chakras are energy centers in the
              body, each one spinning and linked to specific emotions, organs, and aspects of life. There are seven
              primary chakras, each playing a vital role in supplying energy to different parts of the body.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              When in balance, chakras support overall physical, emotional, and spiritual well-being. However,
              imbalances may manifest as emotional turmoil, physical ailments, or a feeling of stagnation in life.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Balancing these energy centers through practices such as meditation, yoga, energy work, crystal healing,
              color visualization, mantras, Reiki, sound healing, affirmations, and focused meditation can restore
              harmony. This process enhances your ability to manifest goals and live with greater intention and purpose.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-secondary/30 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-4xl font-bold text-foreground mb-4">What Blocks Your Energy?</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12 animate-fade-in">
          <h2 className="text-4xl font-bold text-foreground mb-4">Chakra Balancing Benefits</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 animate-fade-in">
        <div className="bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl p-12 text-center">
          <h2 className="text-4xl font-bold text-foreground mb-4">Book your Complimentary Chakra Assessment Now!</h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Experience greater clarity, vitality, and alignment in all areas of life — including your health,
            relationships, career, and self-expression.
          </p>
          <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90">
