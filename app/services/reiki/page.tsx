  ...
  const journeySteps = [
    {
      ...
      desc: "We begin by setting your healing intention",
    },
    {
      step: 2,
      title: "Energy Scan",
      desc: "I assess your energy field and chakras",
    },
    {
      step: 3,
      title: "Reiki Flow",
      desc: "Universal energy flows through specific areas",
    },
    {
      step: 4,
      title: "Release & Balance",
      desc: "Blockages release and harmony restores",
    },
    {
      step: 5,
      title: "Integration",
      desc: "Your body integrates the healing energy",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Find harmony within yourself, fostering a life of tranquility
                and purpose.
              </p>
              <Button
                asChild
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-muted-foreground leading-relaxed mb-4">
              Reiki is a Japanese healing technique that channels universal life
              force energy through the practitioner's hands to the recipient.
              The word "Reiki" comes from two Japanese words: "Rei" meaning
              universal, and "Ki" meaning life force energy.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              During a Reiki session, you remain fully clothed while lying
              comfortably on a treatment table. I gently place my hands on or
              just above specific areas of your body, allowing healing energy to
              flow where it's needed most.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Reiki works on physical, emotional, mental, and spiritual levels,
              promoting overall wellness and helping your body's natural ability
              to heal itself.
            </p>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-up animation-delay-200">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-muted-foreground leading-relaxed mb-4">
                Distance Reiki operates on the principle that energy is not
                constrained by time or space.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Just as we can extend love or intention across great distances,
                Reiki energy can be transmitted remotely through focused
                intention, visualisation and sacred Reiki symbols.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Distance Reiki is considered just as effective as in-person
                sessions, facilitating balance, release, and alignment across
      ...
      <section className="bg-secondary/30 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Each session is unique, and the healing unfolds in perfect
              accordance with the recipient's needs and intentions. Reiki
              sessions are available for children, adults, and elders.
            </p>
          </div>
          ...
          {[
            {
              ...
              desc: "60-90 minutes of deep healing and relaxation",
            },
            {
              icon: Users,
              title: "Personalized Care",
              desc: "Each session is tailored to your unique needs",
            },
            {
              icon: Heart,
              title: "Gentle & Safe",
              desc: "Non-invasive healing suitable for everyone",
            },
          ].map((item, index) => (
            <Card
              key={item.title}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 animate-fade-in">
        <div className="bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl p-12 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Book your Reiki healing session and begin your journey to balance
            and wellness.
          </p>
          <Button
            asChild
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="p-8 border-border animate-fade-in-up">
            ...
            <ul className="space-y-3 text-muted-foreground leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Avoid alcohol for at least 48 hours prior to your session.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                <span>
                  Approach your healing journey with an open mind—true
                  transformation happens when you welcome it wholeheartedly.
                </span>
              </li>
            </ul>
          </Card>
          ...
          <Card className="p-8 border-border animate-fade-in-up animation-delay-100">
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed">
              <p className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                <span>
                  During the session, you may experience profound relaxation or
                  even feel sleepy.
                </span>
              </p>
              <p className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                <span>
                  In the days and weeks following, you may notice increased
          ...
          <Card className="p-8 border-border animate-fade-in-up animation-delay-200">
            ...
            <ul className="space-y-3 text-muted-foreground leading-relaxed">
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                <span>
                  Rest or take a brief nap to allow your body to integrate the
                  healing.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
                <span>
                  Avoid alcohol to maintain the benefits of the session.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-1" />
          ...
          <Card className="p-8 border-border animate-fade-in-up animation-delay-300">
            ...
            <p className="text-muted-foreground leading-relaxed">
              No, Reiki is not a massage! It's an energetic practice focused on
          ...
          <Card className="p-8 border-border animate-fade-in-up animation-delay-400 bg-gradient-to-br from-primary/5 to-accent/5">
            ...
            <p className="text-muted-foreground leading-relaxed mb-3">
              We are always connected via WhatsApp for any follow-up questions
              or aftercare advice.
            </p>
            <p className="text-muted-foreground leading-relaxed">
