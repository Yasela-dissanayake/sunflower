        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 to-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Ready to begin your healing journey? Reach out and let's discuss
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="karmic-numerology">
                        Karmic Numerology
                      </option>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      icon: Mail,
                      title: "Email",
                      content: "hello@sunflowershealing.com",
                    },
                    {
                      icon: Phone,
                      title: "Phone",
